...
public class BoardDataDrawer : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        GameDataInstance.TimeInSeconds = EditorGUILayout.FloatField("Max Game Time (inSeconds)", GameDataInstance.TimeInSeconds);
        ...
        ClearBoardButton();
        FilledUpWithRandomLettersButton();
    ...
    private void InitializeReordableList(ref ReorderableList list, string propertyName, string Lislabel)
    {
        ...
        {
            EditorGUI.LabelField(rect, Lislabel);
        };
    ...
    private void FilledUpWithRandomLettersButton()
    {
